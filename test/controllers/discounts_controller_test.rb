...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { discount_name: @discount.discount_name, end_date: @discount.end_date, percentage_value: @discount.percentage_value, start_date: @discount.start_date } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { discount_name: @discount.discount_name, end_date: @discount.end_date, percentage_value: @discount.percentage_value, start_date: @discount.start_date } }

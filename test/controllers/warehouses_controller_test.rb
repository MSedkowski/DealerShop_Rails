...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { amount: @warehouse.amount, element: @warehouse.element, status: @warehouse.status } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { amount: @warehouse.amount, element: @warehouse.element, status: @warehouse.status } }
